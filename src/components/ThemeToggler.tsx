    ...
    <div className="w-full lg:w-[216px] h-[48px] rounded-xl  flex overflow-hidden">
      ...
      <Button
        ...
        className={clsx(
          ...
          darkActive ? "bg-[#4D5057] hover:bg-gray-900 text-white opacity-100" : "bg-transparent hover:bg-gray-400 text-black/80 opacity-60"
        )}
      >
        <div className="w-6 h-6 relative">
          <Moon className="w-[19.37px] h-[20.01px] absolute top-[2px] left-[2px]" />
        </div>
        <span className="font-inter font-bold text-base leading-6 text-center">Dark</span>
      </Button>
      ...
      <Button
        ...
        className={clsx(
          ...
          lightActive ? "bg-gray-50 text-black hover:bg-gray-400 opacity-100" : "bg-transparent hover:bg-gray-900 text-white/80 opacity-60"
        )}
      >
        <div className="w-6 h-6 relative">
          <Sun className="w-5 h-5 absolute top-[2px] left-[2px]" />
        </div>
        <span className="font-inter font-bold text-base leading-6 text-center">Light</span>
      </Button>
    </div>
  );
};
