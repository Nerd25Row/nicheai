...
const LoginForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-[90%] sm:max-w-md lg:max-w-[540px] opacity-100 gap-6 sm:gap-8 lg:gap-[40px] py-4">
      {/*  */}
      <LogoComponent />
      <div className="w-full rounded-2xl bg-gray-200 dark:bg-[#1D2027] border border-[#393B41] shadow-[0px_15px_70px_-4px_#1018281A] opacity-100 pt-6 px-4 sm:pt-8 sm:px-6 lg:pt-12 lg:px-12 pb-6 sm:pb-8 flex flex-col gap-8 sm:gap-10 lg:gap-[59px] justify-center">
        <div className="w-full flex flex-col gap-6 sm:gap-7 lg:gap-8 opacity-100 text-gray-200">
          ...
          <div className="w-full flex flex-col gap-3 sm:gap-4 opacity-100">
            <span className="text-black dark:text-white text-2xl sm:text-[28px] leading-8 sm:leading-[36px] tracking-[-0.02em] font-inter font-bold text-center opacity-100">
              Welcome Back
            </span>

            <span className="text-gray-600 dark:text-[#B6BCCA] text-sm sm:text-[16px] leading-5 sm:leading-6 tracking-normal font-inter font-normal text-center opacity-100">
              Log in to continue
            </span>
          </div>
          {/* form */}
          ...
          <div className="w-full sm:w-[380px] lg:w-[444px] h-[48px] gap-2 sm:gap-3 lg:gap-4 opacity-100 flex items-center justify-between rounded">
            ...
            <Button
              ...
              className="cursor-pointer flex-1 min-w-0 h-[48px] px-2 sm:px-4 lg:px-6 rounded-lg  bg-gray-200 hover:bg-gray-300 dark:bg-[#2E3137] border border-[#4D5057] shadow-[0px_1px_2px_0px_#1018280D] flex items-center justify-center gap-2 opacity-100 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
            ...
            {/* apple */}
            <Button className="cursor-pointer flex-1 min-w-0 h-[48px] px-2 sm:px-4 lg:px-6 rounded-lg bg-gray-200 hover:bg-gray-300 dark:bg-[#2E3137] border border-[#4D5057] shadow-[0px_1px_2px_0px_#1018280D] flex items-center justify-center gap-2 opacity-100">
